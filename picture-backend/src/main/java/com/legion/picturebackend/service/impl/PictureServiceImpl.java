...
import com.legion.picturebackend.manager.FileManager;
import com.legion.picturebackend.model.dto.file.UploadPictureResult;
...
import com.legion.picturebackend.mapper.PictureMapper;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public void validPicture(Picture picture) {
        ...
        ThrowUtils.throwIf(ObjUtil.isNull(id), ErrorCode.PARAMS_ERROR, "id cant be null");
    ...
    /**
     * 1. check params
     * 2. check if picture exist
     * 3. check if review state repeated
