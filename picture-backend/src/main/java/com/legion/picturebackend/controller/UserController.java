...
import com.legion.picturebackend.model.dto.user.*;
...
public class UserController {
    ...
    /**
     * pagesize means how many data in will show in the page
     * current means which page
     * if query is complicated, we do the post
     */
